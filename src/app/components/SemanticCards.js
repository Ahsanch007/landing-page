    ...
    <div>
      <div className="Page_Section__WvViv Page_Section--appearance-dark__Qf_N8 Page_Section--gap-xl__E8tSh Product_ProductPages__Section__SHAYD Product_ProductPages__Section--animated__q_VW3 Product_ProductPages__Section--inView__V2KYi">
        <div className="Page_SectionHeader__eXcwE Page_SectionHeader--appearance-dark__hGYCv SectionHeader--level-h2">
          <h2 className="Page_SectionHeader__title__tIV1t">{heading}</h2>
        </div>
        <div className="Page_SectionContent__Ztn5n SectionContent--align-none Page_SectionContent--size-m__E6wuQ Page_Section--gap-xl__E8tSh Product_ProductPages__Content__WMlEv">
          <article className="LayersCards_LayersCards__Ky23d LayersCards_LayersCards--inView__18wtK">
            {!dataModel && (
              ...
              >
                <p className="LayersCards_LayersCards__title__3Lh_P">{cards[0].title}</p>
                <p className="LayersCards_LayersCards__description__ZUeGd">{cards[0].description}</p>
            ...
            {!dataAccess && (
              <div
                style={{
                  ...
                  background: "linear-gradient(318deg, var(--card-access-gradient-1), var(--card-access-gradient-2) 75%)",
                  border: "1px solid var(--card-access-border)",
                }}
                className="LayersCards_LayersCards__item__Wz32l"
              >
                <p className="LayersCards_LayersCards__title__3Lh_P">{cards[1].title}</p>
                <p className="LayersCards_LayersCards__description__ZUeGd">{cards[1].description}</p>
            ...
            {!dataCaching && (
              <div
                ...
                style={{
                  ...
                  background: "linear-gradient(316deg, var(--card-caching-gradient-1), var(--card-caching-gradient-2) 75%)",
                  border: "1px solid var(--card-caching-border)",
                }}
              >
                <p className="LayersCards_LayersCards__title__3Lh_P">{cards[2].title}</p>
                <p className="LayersCards_LayersCards__description__ZUeGd">{cards[2].description}</p>
            ...
            {!dataApi && (
              <div
                style={{
                  background: "linear-gradient(316deg, var(--card-api-gradient-1), var(--card-api-gradient-2))",
                  border: "1px solid var(--card-api-border)",
                  backgroundColor: "var(--card-api-bg)",
                }}
                className="LayersCards_LayersCards__item__Wz32l"
              >
                <p className="LayersCards_LayersCards__title__3Lh_P">{cards[3].title}</p>
                <p className="LayersCards_LayersCards__description__ZUeGd">{cards[3].description}</p>
